...
(function () {
    ...
    const SUSHI = {
        ...
        negitoro: {
            read: 'ネギトロ', kanji: '', kr: '네기토로', krRead: '네기토로', romaji: 'Negitoro', level: 1,
            desc: '참치의 기름진 부위를 곱게 다져 만든 네타로, <b>부드럽고 크리미한 식감</b>이 특징이다. 참치의 <b>고소한 감칠맛</b>이 입안에서 살살 풀리며, 흔히 잘게 썬 파를 올려 김을 두른 군함말이로 낸다.',
            sweet: 3, aroma: 2, umami: 4, texture: '부드럽고 크리미',
            feats: ['참치 기름진 부위를 곱게 다진 형태\n분홍빛이 도는 부드러운 살', '잘게 썬 파를 올림\n김 군함말이·마키로 많이 냄']
        },
        mebati: {
