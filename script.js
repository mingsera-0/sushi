...
(function () {
    ...
    const SUSHI = {
        ...
        masu: {
            ...
            desc: '연어와 비슷하면서도 <b>더 담백하고 깔끔한 지방감</b>이 특징인 네타. 부드러운 살에 <b>은은한 단맛</b>이 돌며, 도야마현에서는 식초로 간해 대나무 잎에 싸 누른 향토 초밥 마스즈시로 즐긴다.',
            sweet: 3, aroma: 2, umami: 3, texture: '부드럽고 차짐',
            feats: ['연어보다 연한 연홍빛 살색\n결이 곱고 부드러움', '깔끔하고 산뜻한 지방감\n연어보다 담백하고 비린내가 적음', '도야마현 향토 초밥 마스즈시(鱒寿司)로 유명\n식초로 간해 발효 없이 만듦', '대나무 잎에 싸 둥근 틀에 눌러 만들고\n칼로 부채꼴 조각으로 잘라 먹음']
        }
    };
